...
public class ObjectFactory {
    ...
    private final static QName _Product_QNAME = new QName("http://eatshop.com/product", "org/example/eatshop/product");
     ...
     */
    @XmlElementDecl(namespace = "http://eatshop.com/product", name = "org/example/eatshop/product")
